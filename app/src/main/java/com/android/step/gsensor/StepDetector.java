...
public class StepDetector implements SensorEventListener {
    ...
    private AccChangeListener accChangeListener;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Log.d(TAG, "onSensorChanged: " + oriValues[0]);
        accChangeListener.onAccChange(oriValues[0], oriValues[1], oriValues[2]);
    }
    ...
    public void setAccChangeListener(AccChangeListener accChangeListener) {
        this.accChangeListener = accChangeListener;
    }
}
